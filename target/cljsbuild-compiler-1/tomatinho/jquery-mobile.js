...
var G__3391 = cljs.core.seq.call(null,cljs.core.PersistentVector.fromArray(["now","archive","agenda"], true));
while(true){
if(G__3391)
{var id = cljs.core.first.call(null,G__3391);
var button_class_3392 = [cljs.core.str("button-"),cljs.core.str(id)].join('');
var id_with_hash_3393 = [cljs.core.str("#"),cljs.core.str(id)].join('');
domina.events.listen_BANG_.call(null,domina.by_class.call(null,button_class_3392),"\uFDD0'click",((function (G__3391,button_class_3392,id_with_hash_3393,id){
return (function (){
return $.mobile.changePage(id_with_hash_3393);
});})(G__3391,button_class_3392,id_with_hash_3393,id))
);
{
var G__3394 = cljs.core.next.call(null,G__3391);
G__3391 = G__3394;
continue;
}
} else
...
var G__3396 = cljs.core.seq.call(null,jayq.core.$.call(null,"div[data-role=popup]"));
while(true){
if(G__3396)
{var popup = cljs.core.first.call(null,G__3396);
tomatinho.jquery_mobile.close_popup.call(null,popup);
{
var G__3397 = cljs.core.next.call(null,G__3396);
G__3396 = G__3397;
continue;
}
} else
