...
var G__4405 = null;
var G__4405__2 = (function (self__,k){
var self____$1 = this;
var this$ = self____$1;
return cljs.core._lookup.call(null,this$,k);
});
var G__4405__3 = (function (self__,k,not_found){
var self____$1 = this;
var this$ = self____$1;
return cljs.core._lookup.call(null,this$,k,not_found);
});
G__4405 = function(self__,k,not_found){
switch(arguments.length){
case 2:
return G__4405__2.call(this,self__,k);
case 3:
return G__4405__3.call(this,self__,k,not_found);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
return G__4405;
...
;
jQuery.prototype.apply = (function (self__,args4404){
return self__.call.apply(self__,[self__].concat(args4404.slice()));
});
...
var hide__delegate = function ($elem,p__4406){
var vec__4408 = p__4406;
var speed = cljs.core.nth.call(null,vec__4408,0,null);
var on_finish = cljs.core.nth.call(null,vec__4408,1,null);
return $elem.hide(speed,on_finish);
};
var hide = function ($elem,var_args){
var p__4406 = null;
if (goog.isDef(var_args)) {
  p__4406 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return hide__delegate.call(this, $elem, p__4406);
};
hide.cljs$lang$maxFixedArity = 1;
hide.cljs$lang$applyTo = (function (arglist__4409){
var $elem = cljs.core.first(arglist__4409);
var p__4406 = cljs.core.rest(arglist__4409);
return hide__delegate($elem, p__4406);
});
...
var show__delegate = function ($elem,p__4410){
var vec__4412 = p__4410;
var speed = cljs.core.nth.call(null,vec__4412,0,null);
var on_finish = cljs.core.nth.call(null,vec__4412,1,null);
return $elem.show(speed,on_finish);
};
var show = function ($elem,var_args){
var p__4410 = null;
if (goog.isDef(var_args)) {
  p__4410 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return show__delegate.call(this, $elem, p__4410);
};
show.cljs$lang$maxFixedArity = 1;
show.cljs$lang$applyTo = (function (arglist__4413){
var $elem = cljs.core.first(arglist__4413);
var p__4410 = cljs.core.rest(arglist__4413);
return show__delegate($elem, p__4410);
});
...
var toggle__delegate = function ($elem,p__4414){
var vec__4416 = p__4414;
var speed = cljs.core.nth.call(null,vec__4416,0,null);
var on_finish = cljs.core.nth.call(null,vec__4416,1,null);
return $elem.toggle(speed,on_finish);
};
var toggle = function ($elem,var_args){
var p__4414 = null;
if (goog.isDef(var_args)) {
  p__4414 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return toggle__delegate.call(this, $elem, p__4414);
};
toggle.cljs$lang$maxFixedArity = 1;
toggle.cljs$lang$applyTo = (function (arglist__4417){
var $elem = cljs.core.first(arglist__4417);
var p__4414 = cljs.core.rest(arglist__4417);
return toggle__delegate($elem, p__4414);
});
...
var fade_out__delegate = function ($elem,p__4418){
var vec__4420 = p__4418;
var speed = cljs.core.nth.call(null,vec__4420,0,null);
var on_finish = cljs.core.nth.call(null,vec__4420,1,null);
return $elem.fadeOut(speed,on_finish);
};
var fade_out = function ($elem,var_args){
var p__4418 = null;
if (goog.isDef(var_args)) {
  p__4418 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return fade_out__delegate.call(this, $elem, p__4418);
};
fade_out.cljs$lang$maxFixedArity = 1;
fade_out.cljs$lang$applyTo = (function (arglist__4421){
var $elem = cljs.core.first(arglist__4421);
var p__4418 = cljs.core.rest(arglist__4421);
return fade_out__delegate($elem, p__4418);
});
...
var fade_in__delegate = function ($elem,p__4422){
var vec__4424 = p__4422;
var speed = cljs.core.nth.call(null,vec__4424,0,null);
var on_finish = cljs.core.nth.call(null,vec__4424,1,null);
return $elem.fadeIn(speed,on_finish);
};
var fade_in = function ($elem,var_args){
var p__4422 = null;
if (goog.isDef(var_args)) {
  p__4422 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return fade_in__delegate.call(this, $elem, p__4422);
};
fade_in.cljs$lang$maxFixedArity = 1;
fade_in.cljs$lang$applyTo = (function (arglist__4425){
var $elem = cljs.core.first(arglist__4425);
var p__4422 = cljs.core.rest(arglist__4425);
return fade_in__delegate($elem, p__4422);
});
...
var slide_up__delegate = function ($elem,p__4426){
var vec__4428 = p__4426;
var speed = cljs.core.nth.call(null,vec__4428,0,null);
var on_finish = cljs.core.nth.call(null,vec__4428,1,null);
return $elem.slideUp(speed,on_finish);
};
var slide_up = function ($elem,var_args){
var p__4426 = null;
if (goog.isDef(var_args)) {
  p__4426 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return slide_up__delegate.call(this, $elem, p__4426);
};
slide_up.cljs$lang$maxFixedArity = 1;
slide_up.cljs$lang$applyTo = (function (arglist__4429){
var $elem = cljs.core.first(arglist__4429);
var p__4426 = cljs.core.rest(arglist__4429);
return slide_up__delegate($elem, p__4426);
});
...
var slide_down__delegate = function ($elem,p__4430){
var vec__4432 = p__4430;
var speed = cljs.core.nth.call(null,vec__4432,0,null);
var on_finish = cljs.core.nth.call(null,vec__4432,1,null);
return $elem.slideDown(speed,on_finish);
};
var slide_down = function ($elem,var_args){
var p__4430 = null;
if (goog.isDef(var_args)) {
  p__4430 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1),0);
} 
return slide_down__delegate.call(this, $elem, p__4430);
};
slide_down.cljs$lang$maxFixedArity = 1;
slide_down.cljs$lang$applyTo = (function (arglist__4433){
var $elem = cljs.core.first(arglist__4433);
var p__4430 = cljs.core.rest(arglist__4433);
return slide_down__delegate($elem, p__4430);
});
...
var closest__delegate = function ($elem,selector,p__4434){
var vec__4436 = p__4434;
var context = cljs.core.nth.call(null,vec__4436,0,null);
return $elem.closest(jayq.core.__GT_selector.call(null,selector),context);
};
var closest = function ($elem,selector,var_args){
var p__4434 = null;
if (goog.isDef(var_args)) {
  p__4434 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return closest__delegate.call(this, $elem, selector, p__4434);
};
closest.cljs$lang$maxFixedArity = 2;
closest.cljs$lang$applyTo = (function (arglist__4437){
var $elem = cljs.core.first(arglist__4437);
var selector = cljs.core.first(cljs.core.next(arglist__4437));
var p__4434 = cljs.core.rest(cljs.core.next(arglist__4437));
return closest__delegate($elem, selector, p__4434);
});
...
jayq.core.preprocess_request = (function preprocess_request(p__4440){
var map__4442 = p__4440;
...
var request = map__4442__$1;
var contentType = cljs.core._lookup.call(null,map__4442__$1,"\uFDD0'contentType",null);
var data = cljs.core._lookup.call(null,map__4442__$1,"\uFDD0'data",null);
var ct = jayq.core.__GT_content_type.call(null,contentType);
return (function (p1__4439_SHARP_){
if(cljs.core.truth_(jayq.core.clj_content_type_QMARK_.call(null,ct)))
{return cljs.core.assoc.call(null,p1__4439_SHARP_,"\uFDD0'data",cljs.core.pr_str.call(null,data));
} else
{return p1__4439_SHARP_;
}
}).call(null,(function (p1__4438_SHARP_){
if(cljs.core.truth_(ct))
{return cljs.core.assoc.call(null,p1__4438_SHARP_,"\uFDD0'contentType",ct);
} else
{return p1__4438_SHARP_;
}
}).call(null,request));
});
...
;
jayq.core.xhr = (function xhr(p__4443,content,callback){
var vec__4445 = p__4443;
var method = cljs.core.nth.call(null,vec__4445,0,null);
var uri = cljs.core.nth.call(null,vec__4445,1,null);
...
var unbind__delegate = function ($elem,ev,p__4446){
var vec__4448 = p__4446;
var func = cljs.core.nth.call(null,vec__4448,0,null);
return $elem.unbind(cljs.core.name.call(null,ev),func);
};
var unbind = function ($elem,ev,var_args){
var p__4446 = null;
if (goog.isDef(var_args)) {
  p__4446 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return unbind__delegate.call(this, $elem, ev, p__4446);
};
unbind.cljs$lang$maxFixedArity = 2;
unbind.cljs$lang$applyTo = (function (arglist__4449){
var $elem = cljs.core.first(arglist__4449);
var ev = cljs.core.first(cljs.core.next(arglist__4449));
var p__4446 = cljs.core.rest(cljs.core.next(arglist__4449));
return unbind__delegate($elem, ev, p__4446);
});
...
var on__delegate = function ($elem,events,p__4450){
var vec__4452 = p__4450;
var sel = cljs.core.nth.call(null,vec__4452,0,null);
var data = cljs.core.nth.call(null,vec__4452,1,null);
var handler = cljs.core.nth.call(null,vec__4452,2,null);
return $elem.on(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var on = function ($elem,events,var_args){
var p__4450 = null;
if (goog.isDef(var_args)) {
  p__4450 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return on__delegate.call(this, $elem, events, p__4450);
};
on.cljs$lang$maxFixedArity = 2;
on.cljs$lang$applyTo = (function (arglist__4453){
var $elem = cljs.core.first(arglist__4453);
var events = cljs.core.first(cljs.core.next(arglist__4453));
var p__4450 = cljs.core.rest(cljs.core.next(arglist__4453));
return on__delegate($elem, events, p__4450);
});
...
var one__delegate = function ($elem,events,p__4454){
var vec__4456 = p__4454;
var sel = cljs.core.nth.call(null,vec__4456,0,null);
var data = cljs.core.nth.call(null,vec__4456,1,null);
var handler = cljs.core.nth.call(null,vec__4456,2,null);
return $elem.one(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),data,handler);
};
var one = function ($elem,events,var_args){
var p__4454 = null;
if (goog.isDef(var_args)) {
  p__4454 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return one__delegate.call(this, $elem, events, p__4454);
};
one.cljs$lang$maxFixedArity = 2;
one.cljs$lang$applyTo = (function (arglist__4457){
var $elem = cljs.core.first(arglist__4457);
var events = cljs.core.first(cljs.core.next(arglist__4457));
var p__4454 = cljs.core.rest(cljs.core.next(arglist__4457));
return one__delegate($elem, events, p__4454);
});
...
var off__delegate = function ($elem,events,p__4458){
var vec__4460 = p__4458;
var sel = cljs.core.nth.call(null,vec__4460,0,null);
var handler = cljs.core.nth.call(null,vec__4460,1,null);
return $elem.off(jayq.core.__GT_event.call(null,events),jayq.core.__GT_selector.call(null,sel),handler);
};
var off = function ($elem,events,var_args){
var p__4458 = null;
if (goog.isDef(var_args)) {
  p__4458 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2),0);
} 
return off__delegate.call(this, $elem, events, p__4458);
};
off.cljs$lang$maxFixedArity = 2;
off.cljs$lang$applyTo = (function (arglist__4461){
var $elem = cljs.core.first(arglist__4461);
var events = cljs.core.first(cljs.core.next(arglist__4461));
var p__4458 = cljs.core.rest(cljs.core.next(arglist__4461));
return off__delegate($elem, events, p__4458);
});
...
done.cljs$lang$applyTo = (function (arglist__4462){
var deferred = cljs.core.first(arglist__4462);
var fns_args = cljs.core.rest(arglist__4462);
...
fail.cljs$lang$applyTo = (function (arglist__4463){
var deferred = cljs.core.first(arglist__4463);
var fns_args = cljs.core.rest(arglist__4463);
...
always.cljs$lang$applyTo = (function (arglist__4464){
var deferred = cljs.core.first(arglist__4464);
var fns_args = cljs.core.rest(arglist__4464);
