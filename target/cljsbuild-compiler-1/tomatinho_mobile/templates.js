...
var iter__2540__auto__ = (function iter__23536(s__23537){
return (new cljs.core.LazySeq(null,false,(function (){
var s__23537__$1 = s__23537;
while(true){
if(cljs.core.seq.call(null,s__23537__$1))
{var _ = cljs.core.first.call(null,s__23537__$1);
return cljs.core.cons.call(null,cljs.core.PersistentVector.fromArray(["\uFDD0'img",cljs.core.ObjMap.fromObject(["\uFDD0'src"],{"\uFDD0'src":src})], true),iter__23536.call(null,cljs.core.rest.call(null,s__23537__$1)));
} else
{return null;
}
break;
...
tomatinho.templates.hour_line = (function hour_line(hour,planned,current_set,p__23541,p__23542){
var vec__23545 = p__23541;
var actual_0 = cljs.core.nth.call(null,vec__23545,0,null);
var actual_30 = cljs.core.nth.call(null,vec__23545,1,null);
var vec__23546 = p__23542;
var time_0 = cljs.core.nth.call(null,vec__23546,0,null);
var time_30 = cljs.core.nth.call(null,vec__23546,1,null);
var present_if_true = (function (p1__23538_SHARP_){
if(cljs.core.truth_(p1__23538_SHARP_))
{return "present";
} else
{return "absent";
}
});
var also_current_when = (function (p1__23539_SHARP_,p2__23540_SHARP_){
if(cljs.core.truth_(p1__23539_SHARP_))
{return [cljs.core.str("current "),cljs.core.str(p2__23540_SHARP_)].join('');
} else
{return p2__23540_SHARP_;
}
});
...
return [cljs.core.str("<div"),cljs.core.str(" class=\"buttons\" data-role=\"controlgroup\" data-type=\"horizontal\""),cljs.core.str(">"),cljs.core.str(cljs.core.apply.call(null,cljs.core.str,(function (){var iter__2540__auto__ = (function iter__23549(s__23550){
return (new cljs.core.LazySeq(null,false,(function (){
var s__23550__$1 = s__23550;
while(true){
if(cljs.core.seq.call(null,s__23550__$1))
{var option = cljs.core.first.call(null,s__23550__$1);
return cljs.core.cons.call(null,[cljs.core.str("<a"),cljs.core.str(hiccups.runtime.render_attr_map.call(null,cljs.core.ObjMap.fromObject(["\uFDD0'data-role","\uFDD0'id","\uFDD0'class"],{"\uFDD0'data-role":"button","\uFDD0'id":null,"\uFDD0'class":cljs.core.format.call(null,"b%s %s",cljs.core.name.call(null,option),((cljs.core._EQ_.call(null,option,current))?"ui-btn-active":""))}))),cljs.core.str(">"),cljs.core.str(hiccups.runtime.render_html.call(null,cljs.core.name.call(null,option))),cljs.core.str("</a>")].join(''),iter__23549.call(null,cljs.core.rest.call(null,s__23550__$1)));
} else
{return null;
}
break;
...
return [cljs.core.str("<span"),cljs.core.str(" id=\"timer-text\""),cljs.core.str(">"),cljs.core.str((function (){var attrs23554 = tomatinho.templates.time_string.call(null,now_object);
if(cljs.core.map_QMARK_.call(null,attrs23554))
{return [cljs.core.str("<h1"),cljs.core.str(hiccups.runtime.render_attr_map.call(null,cljs.core.merge.call(null,cljs.core.ObjMap.fromObject(["\uFDD0'id","\uFDD0'class"],{"\uFDD0'id":null,"\uFDD0'class":null}),attrs23554))),cljs.core.str(">"),cljs.core.str("</h1>")].join('');
} else
{return [cljs.core.str("<h1>"),cljs.core.str(hiccups.runtime.render_html.call(null,attrs23554)),cljs.core.str("</h1>")].join('');
}
})()),cljs.core.str((function (){var attrs23555 = (function (){var G__23556 = current;
if(cljs.core._EQ_.call(null,"\uFDD0'pause",G__23556))
{return cljs.core.format.call(null,"(inactive for %d')",(timer / 60));
} else
{if(cljs.core._EQ_.call(null,"\uFDD0'work",G__23556))
...
if(cljs.core.map_QMARK_.call(null,attrs23555))
{return [cljs.core.str("<h2"),cljs.core.str(hiccups.runtime.render_attr_map.call(null,cljs.core.merge.call(null,cljs.core.ObjMap.fromObject(["\uFDD0'id","\uFDD0'class"],{"\uFDD0'id":null,"\uFDD0'class":null}),attrs23555))),cljs.core.str(">"),cljs.core.str("</h2>")].join('');
} else
{return [cljs.core.str("<h2>"),cljs.core.str(hiccups.runtime.render_html.call(null,attrs23555)),cljs.core.str("</h2>")].join('');
}
})()),cljs.core.str("</span>")].join('');
});
tomatinho.templates.pomodoro_list = (function pomodoro_list(p__23557,pomodoro_length,timer,current){
var vec__23566 = p__23557;
var map__23567 = cljs.core.nth.call(null,vec__23566,0,null);
var map__23567__$1 = ((cljs.core.seq_QMARK_.call(null,map__23567))?cljs.core.apply.call(null,cljs.core.hash_map,map__23567):map__23567);
var duration = cljs.core._lookup.call(null,map__23567__$1,"\uFDD0'duration",null);
var end = cljs.core._lookup.call(null,map__23567__$1,"\uFDD0'end",null);
var kind = cljs.core._lookup.call(null,map__23567__$1,"\uFDD0'kind",null);
var items = vec__23566;
...
var end__$1 = cljs.core._lookup.call(null,map__23572__$1,"\uFDD0'end",null);
var distance = cljs.core._lookup.call(null,map__23572__$1,"\uFDD0'distance",null);
var duration__$1 = cljs.core._lookup.call(null,map__23572__$1,"\uFDD0'duration",null);
var kind__$1 = cljs.core._lookup.call(null,map__23572__$1,"\uFDD0'kind",null);
...
})()))].join(''),iter__23568.call(null,cljs.core.rest.call(null,s__23569__$1)));
} else
{return null;
}
break;
...
return [cljs.core.str("<ul"),cljs.core.str(" class=\"goal\" data-role=\"listview\""),cljs.core.str(">"),cljs.core.str(cljs.core.apply.call(null,cljs.core.str,(function (){var iter__2540__auto__ = (function iter__23590(s__23591){
return (new cljs.core.LazySeq(null,false,(function (){
var s__23591__$1 = s__23591;
while(true){
if(cljs.core.seq.call(null,s__23591__$1))
{var vec__23599 = cljs.core.first.call(null,s__23591__$1);
var id = cljs.core.nth.call(null,vec__23599,0,null);
var map__23600 = cljs.core.nth.call(null,vec__23599,1,null);
...
return [cljs.core.str(cljs.core.apply.call(null,cljs.core.str,(function (){var iter__2540__auto__ = (function iter__23614(s__23615){
return (new cljs.core.LazySeq(null,false,(function (){
var s__23615__$1 = s__23615;
while(true){
if(cljs.core.seq.call(null,s__23615__$1))
{var vec__23619 = cljs.core.first.call(null,s__23615__$1);
var id = cljs.core.nth.call(null,vec__23619,0,null);
var map__23620 = cljs.core.nth.call(null,vec__23619,1,null);
var map__23620__$1 = ((cljs.core.seq_QMARK_.call(null,map__23620))?cljs.core.apply.call(null,cljs.core.hash_map,map__23620):map__23620);
var complete = cljs.core._lookup.call(null,map__23620__$1,"\uFDD0'complete",null);
var name = cljs.core._lookup.call(null,map__23620__$1,"\uFDD0'name",null);
return cljs.core.cons.call(null,[cljs.core.str("<li"),cljs.core.str(" class=\"goal\""),cljs.core.str(">"),cljs.core.str((cljs.core.truth_(complete)?[cljs.core.str((function (){var attrs23621 = name;
if(cljs.core.map_QMARK_.call(null,attrs23621))
{return [cljs.core.str("<s"),cljs.core.str(hiccups.runtime.render_attr_map.call(null,cljs.core.merge.call(null,cljs.core.ObjMap.fromObject(["\uFDD0'id","\uFDD0'class"],{"\uFDD0'id":null,"\uFDD0'class":null}),attrs23621))),cljs.core.str(" />")].join('');
} else
{return [cljs.core.str("<s>"),cljs.core.str(hiccups.runtime.render_html.call(null,attrs23621)),cljs.core.str("</s>")].join('');
}
})())].join(''):[cljs.core.str(hiccups.runtime.render_html.call(null,name))].join(''))),cljs.core.str("</li>")].join(''),iter__23614.call(null,cljs.core.rest.call(null,s__23615__$1)));
} else
{return null;
}
break;
...
tomatinho.templates.info_popup = (function info_popup(p__23635,pomodoro_length){
var map__23655 = p__23635;
var map__23655__$1 = ((cljs.core.seq_QMARK_.call(null,map__23655))?cljs.core.apply.call(null,cljs.core.hash_map,map__23655):map__23655);
var history = cljs.core._lookup.call(null,map__23655__$1,"\uFDD0'history",null);
var goals = cljs.core._lookup.call(null,map__23655__$1,"\uFDD0'goals",null);
var feeling = cljs.core._lookup.call(null,map__23655__$1,"\uFDD0'feeling",null);
var date = cljs.core._lookup.call(null,map__23655__$1,"\uFDD0'date",null);
return [cljs.core.str("<div"),cljs.core.str(" data-role=\"popup\" id=\"info-popup\""),cljs.core.str(">"),cljs.core.str(hiccups.runtime.render_html.call(null,tomatinho.templates.header.call(null,date))),cljs.core.str("<p"),cljs.core.str(""),cljs.core.str(">"),cljs.core.str("Feeling: "),cljs.core.str(hiccups.runtime.render_html.call(null,tomatinho.templates.feeling_to_emoticons.call(null,feeling))),cljs.core.str("</p>"),cljs.core.str("<h3>Goals</h3>"),cljs.core.str("<ul"),cljs.core.str(""),cljs.core.str(">"),cljs.core.str(cljs.core.apply.call(null,cljs.core.str,(function (){var iter__2540__auto__ = (function iter__23661(s__23662){
return (new cljs.core.LazySeq(null,false,(function (){
var s__23662__$1 = s__23662;
while(true){
if(cljs.core.seq.call(null,s__23662__$1))
{var map__23665 = cljs.core.first.call(null,s__23662__$1);
var map__23665__$1 = ((cljs.core.seq_QMARK_.call(null,map__23665))?cljs.core.apply.call(null,cljs.core.hash_map,map__23665):map__23665);
var complete = cljs.core._lookup.call(null,map__23665__$1,"\uFDD0'complete",null);
var date__$1 = cljs.core._lookup.call(null,map__23665__$1,"\uFDD0'date",null);
var name = cljs.core._lookup.call(null,map__23665__$1,"\uFDD0'name",null);
return cljs.core.cons.call(null,[cljs.core.str((function (){var attrs23666 = (cljs.core.truth_(complete)?cljs.core.PersistentVector.fromArray(["\uFDD0's",name], true):name);
if(cljs.core.map_QMARK_.call(null,attrs23666))
{return [cljs.core.str("<li"),cljs.core.str(hiccups.runtime.render_attr_map.call(null,cljs.core.merge.call(null,cljs.core.ObjMap.fromObject(["\uFDD0'id","\uFDD0'class"],{"\uFDD0'id":null,"\uFDD0'class":null}),attrs23666))),cljs.core.str(">"),cljs.core.str("</li>")].join('');
} else
{return [cljs.core.str("<li>"),cljs.core.str(hiccups.runtime.render_html.call(null,attrs23666)),cljs.core.str("</li>")].join('');
}
})())].join(''),iter__23661.call(null,cljs.core.rest.call(null,s__23662__$1)));
} else
{return null;
}
break;
...
return iter__2540__auto__.call(null,goals);
})())),cljs.core.str("</ul>"),cljs.core.str("<h3>Pomodoros</h3>"),cljs.core.str("<table"),cljs.core.str(""),cljs.core.str(">"),cljs.core.str((function (){var attrs23660 = (function (){var vec__23667 = tomatinho.utils.aggregate_time_blocks.call(null,history,pomodoro_length,10);
var h = cljs.core.nth.call(null,vec__23667,0,null);
var t = cljs.core.nthnext.call(null,vec__23667,1);
var h__$1 = cljs.core.filter.call(null,(function (p1__23630_SHARP_){
return cljs.core._EQ_.call(null,(new cljs.core.Keyword("\uFDD0'kind")).call(null,p1__23630_SHARP_),"\uFDD0'pomodoro");
}),h);
var iter__2540__auto__ = (function iter__23668(s__23669){
return (new cljs.core.LazySeq(null,false,(function (){
var s__23669__$1 = s__23669;
while(true){
if(cljs.core.seq.call(null,s__23669__$1))
{var group = cljs.core.first.call(null,s__23669__$1);
...
return (function iter__23672(s__23673){
return (new cljs.core.LazySeq(null,false,((function (group){
return (function (){
var s__23673__$1 = s__23673;
while(true){
if(cljs.core.seq.call(null,s__23673__$1))
{var _ = cljs.core.first.call(null,s__23673__$1);
return cljs.core.cons.call(null,cljs.core.PersistentVector.fromArray(["\uFDD0'img",cljs.core.ObjMap.fromObject(["\uFDD0'src","\uFDD0'style"],{"\uFDD0'src":"img/tomate.png","\uFDD0'style":"width: 1em"})], true),iter__23672.call(null,cljs.core.rest.call(null,s__23673__$1)));
} else
{return null;
}
break;
...
})()], true)], true),iter__23668.call(null,cljs.core.rest.call(null,s__23669__$1)));
} else
{return null;
}
break;
...
if(cljs.core.map_QMARK_.call(null,attrs23660))
{return [cljs.core.str("<tbody"),cljs.core.str(hiccups.runtime.render_attr_map.call(null,cljs.core.merge.call(null,cljs.core.ObjMap.fromObject(["\uFDD0'id","\uFDD0'class"],{"\uFDD0'id":null,"\uFDD0'class":null}),attrs23660))),cljs.core.str(" />")].join('');
} else
{return [cljs.core.str("<tbody>"),cljs.core.str(hiccups.runtime.render_html.call(null,attrs23660)),cljs.core.str("</tbody>")].join('');
}
})()),cljs.core.str("</table>"),cljs.core.str("</div>")].join('');
});
tomatinho.templates.archive_popup = (function archive_popup(){
return [cljs.core.str("<div"),cljs.core.str(" data-role=\"popup\" id=\"archive-popup\""),cljs.core.str(">"),cljs.core.str(hiccups.runtime.render_html.call(null,tomatinho.templates.header.call(null,"How did it go?"))),cljs.core.str(cljs.core.apply.call(null,cljs.core.str,(function (){var iter__2540__auto__ = (function iter__23676(s__23677){
return (new cljs.core.LazySeq(null,false,(function (){
var s__23677__$1 = s__23677;
while(true){
if(cljs.core.seq.call(null,s__23677__$1))
{var x = cljs.core.first.call(null,s__23677__$1);
return cljs.core.cons.call(null,[cljs.core.str("<button"),cljs.core.str(hiccups.runtime.render_attr_map.call(null,cljs.core.ObjMap.fromObject(["\uFDD0'id","\uFDD0'class"],{"\uFDD0'id":[cljs.core.str("f"),cljs.core.str(x)].join(''),"\uFDD0'class":null}))),cljs.core.str(">"),cljs.core.str(hiccups.runtime.render_html.call(null,tomatinho.templates.feeling_to_emoticons.call(null,x))),cljs.core.str("</button>")].join(''),iter__23676.call(null,cljs.core.rest.call(null,s__23677__$1)));
} else
{return null;
}
break;
...
})())?"within":null)))}))),cljs.core.str(">"),cljs.core.str(hiccups.runtime.render_html.call(null,hour)),cljs.core.str("</td>"),cljs.core.str("</tr>")].join(''),iter__23684.call(null,cljs.core.rest.call(null,s__23685__$1)));
} else
{return null;
}
break;
...
{var iter__2540__auto__ = (function iter__23696(s__23697){
return (new cljs.core.LazySeq(null,false,(function (){
var s__23697__$1 = s__23697;
while(true){
if(cljs.core.seq.call(null,s__23697__$1))
{var vec__23700 = cljs.core.first.call(null,s__23697__$1);
var n = cljs.core.nth.call(null,vec__23700,0,null);
var map__23701 = cljs.core.nth.call(null,vec__23700,1,null);
var map__23701__$1 = ((cljs.core.seq_QMARK_.call(null,map__23701))?cljs.core.apply.call(null,cljs.core.hash_map,map__23701):map__23701);
var history = cljs.core._lookup.call(null,map__23701__$1,"\uFDD0'history",null);
var goals = cljs.core._lookup.call(null,map__23701__$1,"\uFDD0'goals",null);
var feeling = cljs.core._lookup.call(null,map__23701__$1,"\uFDD0'feeling",null);
var date = cljs.core._lookup.call(null,map__23701__$1,"\uFDD0'date",null);
...
domina.events.listen_BANG_.call(null,node,"\uFDD0'click",((function (item,node,vec__23700,n,map__23701,map__23701__$1,history,goals,feeling,date){
return (function (){
return on_click_fn.call(null,n);
});})(item,node,vec__23700,n,map__23701,map__23701__$1,history,goals,feeling,date))
);
return node;
})(),iter__23696.call(null,cljs.core.rest.call(null,s__23697__$1)));
} else
{return null;
}
break;
