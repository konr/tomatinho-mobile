...
var self__ = this;
return cljs.core.swap_BANG_.call(null,self__.buffer_atom,(function (p1__3536_SHARP_){
return cljs.core.cons.call(null,ch,p1__3536_SHARP_);
}));
});
...
reader_error.cljs$lang$applyTo = (function (arglist__3537){
var rdr = cljs.core.first(arglist__3537);
var msg = cljs.core.rest(arglist__3537);
...
{{
var G__3538 = (function (){sb.append(ch);
return sb;
})();
var G__3539 = cljs.reader.read_char.call(null,rdr);
sb = G__3538;
ch = G__3539;
continue;
}
...
{{
var G__3540 = cljs.reader.read_char.call(null,rdr);
ch = G__3540;
continue;
}
} else
...
{
var G__3541 = (((mret === rdr))?a:cljs.core.conj_BANG_.call(null,a,mret));
a = G__3541;
continue;
}
} else
...
{
var G__3542 = (((o === rdr))?a:cljs.core.conj_BANG_.call(null,a,o));
a = G__3542;
continue;
}
}
...
{{
var G__3543 = (function (){buffer.append(ch);
return buffer;
})();
var G__3544 = cljs.reader.read_char.call(null,reader);
buffer = G__3543;
ch = G__3544;
continue;
}
...
{if(("\\" === ch))
{{
var G__3545 = (function (){buffer.append(cljs.reader.escape_char.call(null,buffer,reader));
return buffer;
})();
var G__3546 = cljs.reader.read_char.call(null,reader);
buffer = G__3545;
ch = G__3546;
continue;
}
...
{if("\uFDD0'default")
{{
var G__3547 = (function (){buffer.append(ch);
return buffer;
})();
var G__3548 = cljs.reader.read_char.call(null,reader);
buffer = G__3547;
ch = G__3548;
continue;
}
...
if((function (){var G__3550 = o;
if(G__3550)
{if((function (){var or__3824__auto__ = (G__3550.cljs$lang$protocol_mask$partition0$ & 262144);
if(or__3824__auto__)
{return or__3824__auto__;
} else
{return G__3550.cljs$core$IWithMeta$;
}
})())
{return true;
} else
{if((!G__3550.cljs$lang$protocol_mask$partition0$))
{return cljs.core.type_satisfies_.call(null,cljs.core.IWithMeta,G__3550);
} else
{return false;
}
}
...
{{
var G__3551 = reader;
var G__3552 = eof_is_error;
var G__3553 = sentinel;
var G__3554 = is_recursive;
reader = G__3551;
eof_is_error = G__3552;
sentinel = G__3553;
is_recursive = G__3554;
continue;
}
} else
{if(cljs.reader.comment_prefix_QMARK_.call(null,ch))
{{
var G__3555 = cljs.reader.read_comment.call(null,reader,ch);
var G__3556 = eof_is_error;
var G__3557 = sentinel;
var G__3558 = is_recursive;
reader = G__3555;
eof_is_error = G__3556;
sentinel = G__3557;
is_recursive = G__3558;
continue;
}
} else
{if("\uFDD0'else")
...
{{
var G__3559 = reader;
var G__3560 = eof_is_error;
var G__3561 = sentinel;
var G__3562 = is_recursive;
reader = G__3559;
eof_is_error = G__3560;
sentinel = G__3561;
is_recursive = G__3562;
continue;
}
} else
{return res;
...
{var vec__3568 = temp__3974__auto__;
var vec__3569 = cljs.core.nth.call(null,vec__3568,0,null);
var _ = cljs.core.nth.call(null,vec__3569,0,null);
var years = cljs.core.nth.call(null,vec__3569,1,null);
var months = cljs.core.nth.call(null,vec__3569,2,null);
var days = cljs.core.nth.call(null,vec__3569,3,null);
var hours = cljs.core.nth.call(null,vec__3569,4,null);
var minutes = cljs.core.nth.call(null,vec__3569,5,null);
var seconds = cljs.core.nth.call(null,vec__3569,6,null);
var milliseconds = cljs.core.nth.call(null,vec__3569,7,null);
var vec__3570 = cljs.core.nth.call(null,vec__3568,1,null);
var ___$1 = cljs.core.nth.call(null,vec__3570,0,null);
var ___$2 = cljs.core.nth.call(null,vec__3570,1,null);
var ___$3 = cljs.core.nth.call(null,vec__3570,2,null);
var V = vec__3568;
var vec__3571 = cljs.core.map.call(null,(function (v){
return cljs.core.map.call(null,(function (p1__3567_SHARP_){
return parseInt(p1__3567_SHARP_,10);
}),v);
}),cljs.core.map.call(null,(function (p1__3565_SHARP_,p2__3564_SHARP_){
return cljs.core.update_in.call(null,p2__3564_SHARP_,cljs.core.PersistentVector.fromArray([0], true),p1__3565_SHARP_);
}),cljs.core.PersistentVector.fromArray([cljs.core.constantly.call(null,null),(function (p1__3566_SHARP_){
if(cljs.core._EQ_.call(null,p1__3566_SHARP_,"-"))
{return "-1";
} else
{return "1";
}
...
var ___$4 = cljs.core.nth.call(null,vec__3572,0,null);
var y = cljs.core.nth.call(null,vec__3572,1,null);
var mo = cljs.core.nth.call(null,vec__3572,2,null);
var d = cljs.core.nth.call(null,vec__3572,3,null);
var h = cljs.core.nth.call(null,vec__3572,4,null);
var m = cljs.core.nth.call(null,vec__3572,5,null);
var s = cljs.core.nth.call(null,vec__3572,6,null);
var ms = cljs.core.nth.call(null,vec__3572,7,null);
var vec__3573 = cljs.core.nth.call(null,vec__3571,1,null);
var offset_sign = cljs.core.nth.call(null,vec__3573,0,null);
var offset_hours = cljs.core.nth.call(null,vec__3573,1,null);
var offset_minutes = cljs.core.nth.call(null,vec__3573,2,null);
...
if(cljs.core.truth_(temp__3971__auto__))
{var vec__3575 = temp__3971__auto__;
var years = cljs.core.nth.call(null,vec__3575,0,null);
var months = cljs.core.nth.call(null,vec__3575,1,null);
var days = cljs.core.nth.call(null,vec__3575,2,null);
var hours = cljs.core.nth.call(null,vec__3575,3,null);
var minutes = cljs.core.nth.call(null,vec__3575,4,null);
var seconds = cljs.core.nth.call(null,vec__3575,5,null);
var ms = cljs.core.nth.call(null,vec__3575,6,null);
var offset = cljs.core.nth.call(null,vec__3575,7,null);
